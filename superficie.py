...
def main():
	mat_red_diffuse = array( ( 0.7, 0.0, 0.1, 1.0 ), 'f' )
	mat_green_diffuse = array(( 0.0, 0.7, 0.1, 1.0 ),'f')
	mat_blue_diffuse = array(( 0.0, 0.1, 0.7, 1.0 ),'f')
	mat_yellow_diffuse = array(( 0.7, 0.8, 0.1, 1.0 ),'f')
	...
	gluNurbsProperty(nurb, GLU_DISPLAY_MODE, GLU_FILL) # GLU_OUTLINE_POLYGON
